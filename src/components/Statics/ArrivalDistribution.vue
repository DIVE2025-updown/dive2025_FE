...
<template>
    <section class="bg-white rounded-2xl shadow-sm p-6 md:p-8 text-center">
        <h2 class="text-xl md:text-2xl font-bold mb-1">How many dogs or cats arrive at shelters?</h2>
        <p class="text-gray-600 mb-6">Discover how many animals arrive at shelters and how their characteristics are distributed. Is there anything that surprises you?</p>
        <p class="text-2xl md:text-3xl font-bold text-gray-800 mb-8">In 2024 were taken in...</p>
        ...
        <div class="flex flex-col md:flex-row justify-around items-center gap-8">
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="font-semibold text-[#D9534F]">173,867 DOGS</p>
                </div>
                <div class="flex items-center gap-3 mt-4 bg-gray-100 px-4 py-2 rounded-full">
                    <div class="bg-[#D9534F] p-2 rounded-full">
                        <Icon name="dog-silhouette" class="w-6 h-6 text-white" />
                    </div>
                    <span class="font-bold">Dog</span>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="font-semibold text-gray-700">118,151 CATS</p>
                </div>
                <div class="flex items-center gap-3 mt-4 bg-gray-100 px-4 py-2 rounded-full">
                    <div class="bg-gray-400 p-2 rounded-full">
                        <Icon name="cat-silhouette" class="w-6 h-6 text-white" />
                    </div>
