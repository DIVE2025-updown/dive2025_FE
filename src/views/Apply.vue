    ...
    <div class="top-filter-bar" v-if="!isApplying">
      <div class="filter-content">
          ...
          <transition name="filter-fade">
            <div class="other-filters" v-if="isFilterOpen">
              ...
              <button
                ...
                :class="{ active: filters.conditions.includes('MILD') }"
              >
                경증
              </button>
              <button
                ...
                :class="{ active: filters.conditions.includes('SEVERE') }"
              >
                중증
              </button>
              ...
              <button
                ...
                :class="{ active: filters.usePeriod && filters.dueWithinDays === 3 }"
              >
                3일 이내
              </button>
              <button
                ...
                :class="{ active: filters.usePeriod && filters.dueWithinDays === 0 }"
              >
                경과
              </button>
              ...
              >
                ...
                <i
                  ...
                  :class="
                    filters.order === 'asc' ? 'fa-solid fa-arrow-up' : 'fa-solid fa-arrow-down'
                  "
                ></i>
              </button>
        ...
        <button
          ...
          @click="
            applicationsStore.cancelApplication(applicationMap[selectedImage].id, auth.shelterId)
          "
        >
          이관 취소
        </button>

        <button class="filter-apply" v-else @click="openModal" :disabled="!selectedImage">
          이관 신청
        </button>
      </div>
    </div>
      ...
      <div class="animals-container">
        ...
        >
          <div v-if="filters.conditions.length > 0 || filters.usePeriod" class="active-filters">
            ...
            <span
              v-if="filters.usePeriod && filters.dueWithinDays === 0"
              key="overdue"
              class="chip"
            >
              보호기간 경과
            ...
            <span
              v-if="filters.usePeriod && filters.dueWithinDays === 3"
              key="dueSoon"
              class="chip"
            >
              보호기간 3일 이내
        ...
        <div class="image-list" @scroll.passive="handleScroll">
          <div class="image-item" v-for="image in images" :key="image.id">
            ...
            >
              ...
              <div
                class="tag-container"
                :class="applicationMap[image.id] ? 'transfer-tag' : 'danger-tag'"
                v-if="image.needsTransfer || applicationMap[image.id]"
              >
            ...
            <div class="info-box">
              <div class="meta-top">
                <!-- 컨디션 Pill (선택적) -->
                <span class="cond-pill" :class="conditionClass(image.animalCondition)">
      ...
      <div v-else class="shelter-list in-modal">
        <div class="info">
          <p class="info-content">
            Paw-on은 {{ rescued }} 에게 <br />
            가장 적합한 보호소를 추천해 줘요!
          </p>
          <div class="explain">
            <div class="explain-icon">💡</div>
            <div class="explain-content">
              <u>동물의 상태</u>에 맞는 보호소 중<br /><u>가장 가까운 곳</u>을 기준으로 추천해요!
            </div>
          </div>
        </div>
        ...
        >
          <div class="count">{{ destinationShelters.indexOf(shelter) + 1 }}</div>
